...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/item_4.png
  AssetGenImage get item4 => const AssetGenImage('assets/images/item_4.png');

  /// File path: assets/images/item_5.png
  AssetGenImage get item5 => const AssetGenImage('assets/images/item_5.png');

  /// File path: assets/images/item_6.png
  AssetGenImage get item6 => const AssetGenImage('assets/images/item_6.png');
  ...
  /// File path: assets/images/score_board.png
  AssetGenImage get scoreBoard =>
      const AssetGenImage('assets/images/score_board.png');
